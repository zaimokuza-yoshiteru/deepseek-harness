...
This fork distributes an Electron application with DSH `0.1.5-alpha.2`, `@zaimokuza/dsh-acp-adapter` `0.1.5-alpha.2`, upstream Node.js `24.17.0`, pnpm `11.7.0`, and an offline installation seed. Users do not install DSH, Node.js, npm, or pnpm separately. ACP agent executables are configured separately; they are not included.
