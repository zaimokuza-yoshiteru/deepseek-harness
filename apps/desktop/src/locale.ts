...
export const en = {
  ...
  agentTeamsDescription: 'Enable team tools and the team panel together. Dependencies stay installed for offline reactivation. Switching restarts the backend and keeps your conversations.',
  agentTeamsChanging: 'Changing Agent Teams…',
  featureSwitchBusy: 'Another feature change is in progress. Please try again shortly.',
  featureTasksRunning: 'Tasks or requests are still running. Wait for them to finish or stop them before changing Agent Teams.',
  refresh: 'Refresh',
...
export const zh = {
  ...
  agentTeams: 'Agent Teams',
  agentTeamsDescription: '同时启停团队协作工具和团队面板。依赖始终保留，重新开启无需联网。切换会重启后端，并保留会话数据。',
  agentTeamsChanging: '正在切换 Agent Teams…',
  featureSwitchBusy: '正在进行另一项功能切换，请稍后重试。',
  featureTasksRunning: '仍有任务或请求正在运行。请等待完成或停止任务后，再切换 Agent Teams。',
  refresh: '刷新',
  npmPackage: 'npm 包',
  install: '安装',
  installed: '已安装',
