...
if (version === undefined || !/^0\.1\.7\.alpha\.2\.[1-9][0-9]*$/u.test(version)) {
  throw new Error('Expected DSH_DESKTOP_DISTRIBUTION_VERSION=0.1.7.alpha.2.<positive integer>')
}
const root = JSON.parse(readFileSync(new URL('../../../package.json', import.meta.url)))
if (root.version !== '0.1.7-alpha.2') throw new Error('This desktop line requires DSH 0.1.7-alpha.2')
